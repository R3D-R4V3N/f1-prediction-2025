...
CIRCUIT_METADATA = {
    'Bahrain Grand Prix': {'NumCorners': 15, 'DRSZones': 3, 'StdLapTime': 92, 'WeatherVolatility': 0.3},
    'Saudi Arabian Grand Prix': {'NumCorners': 27, 'DRSZones': 3, 'StdLapTime': 90, 'WeatherVolatility': 0.3},
    'Australian Grand Prix': {'NumCorners': 14, 'DRSZones': 4, 'StdLapTime': 80, 'WeatherVolatility': 0.6},
    'Japanese Grand Prix': {'NumCorners': 18, 'DRSZones': 1, 'StdLapTime': 93, 'WeatherVolatility': 0.7},
    'Chinese Grand Prix': {'NumCorners': 16, 'DRSZones': 2, 'StdLapTime': 95, 'WeatherVolatility': 0.7},
    'Miami Grand Prix': {'NumCorners': 19, 'DRSZones': 3, 'StdLapTime': 90, 'WeatherVolatility': 0.8},
    'Emilia Romagna Grand Prix': {'NumCorners': 19, 'DRSZones': 2, 'StdLapTime': 75, 'WeatherVolatility': 0.7},
    'Monaco Grand Prix': {'NumCorners': 19, 'DRSZones': 1, 'StdLapTime': 72, 'WeatherVolatility': 0.4},
    'Canadian Grand Prix': {'NumCorners': 14, 'DRSZones': 2, 'StdLapTime': 70, 'WeatherVolatility': 0.9},
    'Spanish Grand Prix': {'NumCorners': 14, 'DRSZones': 2, 'StdLapTime': 78, 'WeatherVolatility': 0.5},
    'Austrian Grand Prix': {'NumCorners': 10, 'DRSZones': 3, 'StdLapTime': 65, 'WeatherVolatility': 0.8},
    'British Grand Prix': {'NumCorners': 18, 'DRSZones': 2, 'StdLapTime': 85, 'WeatherVolatility': 1.0},
    'Hungarian Grand Prix': {'NumCorners': 14, 'DRSZones': 2, 'StdLapTime': 76, 'WeatherVolatility': 0.6},
    'Belgian Grand Prix': {'NumCorners': 19, 'DRSZones': 2, 'StdLapTime': 112, 'WeatherVolatility': 1.0},
    'Dutch Grand Prix': {'NumCorners': 14, 'DRSZones': 2, 'StdLapTime': 72, 'WeatherVolatility': 0.8},
    'Italian Grand Prix': {'NumCorners': 11, 'DRSZones': 2, 'StdLapTime': 79, 'WeatherVolatility': 0.4},
    'Azerbaijan Grand Prix': {'NumCorners': 20, 'DRSZones': 2, 'StdLapTime': 100, 'WeatherVolatility': 0.7},
    'Singapore Grand Prix': {'NumCorners': 19, 'DRSZones': 3, 'StdLapTime': 103, 'WeatherVolatility': 0.6},
    'United States Grand Prix': {'NumCorners': 20, 'DRSZones': 2, 'StdLapTime': 90, 'WeatherVolatility': 0.6},
    'Mexican Grand Prix': {'NumCorners': 17, 'DRSZones': 3, 'StdLapTime': 77, 'WeatherVolatility': 0.5},
    'Brazilian Grand Prix': {'NumCorners': 15, 'DRSZones': 2, 'StdLapTime': 72, 'WeatherVolatility': 0.9},
    'Las Vegas Grand Prix': {'NumCorners': 17, 'DRSZones': 2, 'StdLapTime': 95, 'WeatherVolatility': 0.3},
    'Qatar Grand Prix': {'NumCorners': 16, 'DRSZones': 2, 'StdLapTime': 81, 'WeatherVolatility': 0.3},
    'Abu Dhabi Grand Prix': {'NumCorners': 16, 'DRSZones': 2, 'StdLapTime': 85, 'WeatherVolatility': 0.3},
}
